...
function add_product_post_type() {
	...
	register_post_type( 'product',
		array(
			...
			'description' => 'Discover the Synergy difference.',
			'public' => true,
			'has_archive' => true,
			'menu_position' => 5,
			'hierarchical' => true,
...
function add_faq_post_type() {
	...
	register_post_type( 'faq',
		array(
			...
			'description' => 'Have a question? Search our FAQs for fast answers.',
			'public' => true,
			'has_archive' => true,
			'hierarchical' => true,
			'menu_position' => 5,
...
function add_training_video_post_type() {
	...
	register_post_type( 'training-video',
		array(
			...
			'description' => 'Helpful training videos from the Synergy team.',
			'public' => true,
			'has_archive' => true,
			'hierarchical' => true,
			'menu_position' => 5,
