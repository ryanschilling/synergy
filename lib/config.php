 ...
 */
define('GOOGLE_ANALYTICS_ID', 'UA-50367065-1'); // UA-XXXXX-Y (Note: Uses Universal Analytics only, not Classic Analytics)
define('GOOGLE_ANALYTICS_HOST', 'synergytele.com'); // example.com
