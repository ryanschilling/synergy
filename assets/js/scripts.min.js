...
})},a.fn.ekkoLightbox.defaults={gallery_parent_selector:"*:not(.row)",left_arrow_class:".glyphicon .glyphicon-chevron-left",right_arrow_class:".glyphicon .glyphicon-chevron-right",directional_arrows:!0,type:null,always_show_close:!0,onShow:function(){},onShown:function(){},onHide:function(){},onHidden:function(){}}}.call(this),function(a){var b={common:{init:function(){a(document).delegate('*[data-toggle="lightbox"]',"click",function(b){return b.preventDefault(),a(this).ekkoLightbox()}),a(".counter-minus").click(function(){var b=a(this).parents(".input-group").find(".counter"),c=1*b.val();c=Math.max(0,c-1),b.val(c)}),a(".counter-plus").click(function(){var b=a(this).parents(".input-group").find(".counter"),c=1*b.val();b.val(c+1)}),a(window).width()>767&&(a(window).resize(function(){var b=a("#menu-main-menu").width(),c=a("#menu-main-menu").offset().left;a("#menu-main-menu > .menu-solutions > .dropdown-menu,#menu-main-menu > .menu-products > .dropdown-menu,#menu-main-menu > .menu-support > .dropdown-menu").each(function(){var d=a(this).parents("li.dropdown").offset().left;a(this).css({left:-d+c,width:b})})}).trigger("resize"),a("#menu-main-menu > .menu-solutions > .dropdown-menu").html(a("#menu-solutions-dropdown").html()),a("#menu-main-menu > .menu-products > .dropdown-menu").html(a("#menu-products-dropdown").html()),a("#menu-main-menu > .menu-support > .dropdown-menu").html(a("#menu-support-dropdown").html())),a(".faq-collapse").first().find('a[data-toggle="collapse"]').trigger("click");var b=/^\/support\/knowledge-base/i;b.test(window.location.pathname)&&a(".menu-support .dropdown.menu-knowledge-base").addClass("active"),b=/^\/support\/knowledge-base\/section\/([^\/]+)/i;var c=a(".breadcrumb li:nth-child(4) a").attr("href");b.test(c)&&a('.menu-support .dropdown.menu-knowledge-base a[href^="'+c+'"]').parents("li").addClass("active"),b=/^\/support\/training-videos/i,b.test(window.location.pathname)&&a(".menu-support .dropdown.menu-training-videos").addClass("active"),b=/^\/support\/training-videos\/series\/([^\/]+)/i,c=a(".breadcrumb li:nth-child(4) a").attr("href"),b.test(c)&&a('.menu-support .dropdown.menu-training-videos a[href^="'+c+'"]').parents("li").addClass("active"),b=/^\/solutions\/industries/i,b.test(window.location.pathname)&&a(".menu-solutions .menu-voip-industries").addClass("active");var d=Math.round(2*Math.random());a(".widget_customer_review").length&&(a(".widget_customer_review").find("blockquote.review").hide(),a(".widget_customer_review").find("blockquote.review:eq("+d+")").fadeIn(250)),a("#menu-main-menu, #menu-utility-menu").find("li.dropdown").hover(function(){a(window).width()>767&&a(this).addClass("open")},function(){a(window).width()>767&&a(this).removeClass("open")}).click(function(){a(window).width()>767&&(document.location=document.location.protocol+"//"+document.location.hostname+a(this).find("a").first().attr("href"))}),a(".widget_product_reviews").length&&a("li.list-group-item",".widget_product_reviews").length>2&&(a("li.list-group-item",".widget_product_reviews").first().hide(),setInterval(function(){var b=a(".widget_product_reviews");a("li.list-group-item",b).last().fadeOut(500,function(){a("ul.list-group",b).prepend(a(this))}),a("li.list-group-item",b).first().slideDown(500)},3e3))}}},c={fire:function(a,c,d){var e=b;c=void 0===c?"init":c,""!==a&&e[a]&&"function"==typeof e[a][c]&&e[a][c](d)},loadEvents:function(){c.fire("common"),a.each(document.body.className.replace(/-/g,"_").split(/\s+/),function(a,b){c.fire(b)})}};a(document).ready(c.loadEvents)}(jQuery);