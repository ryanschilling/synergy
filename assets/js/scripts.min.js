...
})},a.fn.ekkoLightbox.defaults={gallery_parent_selector:"*:not(.row)",left_arrow_class:".glyphicon .glyphicon-chevron-left",right_arrow_class:".glyphicon .glyphicon-chevron-right",directional_arrows:!0,type:null,always_show_close:!0,onShow:function(){},onShown:function(){},onHide:function(){},onHidden:function(){}}}.call(this),function(a){var b={common:{init:function(){a(document).delegate('*[data-toggle="lightbox"]',"click",function(b){return b.preventDefault(),a(this).ekkoLightbox()}),a(".faq-collapse").first().find('a[data-toggle="collapse"]').trigger("click");var b=/^\/support\/knowledge-base/i;b.test(window.location.pathname)&&a(".menu-support .dropdown.menu-knowledge-base").addClass("active"),b=/^\/support\/knowledge-base\/section\/([^\/]+)/i;var c=a(".breadcrumb li:nth-child(4) a").attr("href");b.test(c)&&a('.menu-support .dropdown.menu-knowledge-base a[href^="'+c+'"]').parents("li").addClass("active")}},home:{init:function(){}},about_us:{init:function(){}}},c={fire:function(a,c,d){var e=b;c=void 0===c?"init":c,""!==a&&e[a]&&"function"==typeof e[a][c]&&e[a][c](d)},loadEvents:function(){c.fire("common"),a.each(document.body.className.replace(/-/g,"_").split(/\s+/),function(a,b){c.fire(b)})}};a(document).ready(c.loadEvents)}(jQuery);